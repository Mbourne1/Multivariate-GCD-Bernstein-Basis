function [Sk1k2] = BuildSubresultant_Bivariate_3Polys_2Eqns(fxy, gxy, hxy, k1, k2)
...
switch SETTINGS.SYLVESTER_MATRIX_VARIANT
    ...
    case 'T'
        ...
        T = BuildT_Bivariate_3Polys_2Eqns(fxy, gxy, hxy, k1, k2);
        
        Sk1k2 = T;
        
    case 'DT'
        
        D = BuildD_Bivariate_3Polys_2Eqns(m1, m2, n1, n2, o1, o2, k1, k2);
        T = BuildT_Bivariate_3Polys_2Eqns(fxy, gxy, hxy, k1, k2);
