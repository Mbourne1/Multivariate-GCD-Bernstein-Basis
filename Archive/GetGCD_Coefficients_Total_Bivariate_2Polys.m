function [dxy_calc_matrix] = GetGCD_Coefficients_Total_Bivariate_2Polys(uxy,vxy,...
    fxy,gxy,...
    m, n, t,...
    GM_fx, GM_gx,...
    alpha, th1, th2)
...
% % Inputs 
%
% [uxy, vxy] : (Matrix) Coefficients of polynomials u(x,y) and v(x,y)
%
% [fxy, gxy] : (Matrix) Coefficients of polynomials f(x,y) and g(x,y)
%
% t1 :
%
% t2 :
%
% [GM_fx, GM_gx] : (Float) Geometric means of f(x,y) and g(x,y) in S_{t}
%
% opt_alpha :
%
% [th1, th2] :
...
C1_u = BuildT1_bivar(uww_matrix,t,t);
C2_v = BuildT1_bivar(vww_matrix,t,t);
