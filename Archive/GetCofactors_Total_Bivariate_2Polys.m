function [uxy, vxy] = GetCofactors_Total_Bivariate_2Polys(fxy, gxy, m, n, t)
...
switch SETTINGS.SYLVESTER_BUILD_METHOD
    ...
    case 'DT'
        ...
        vxy = GetWithoutBinomials(vxy_bi);
        
        % Remove the binomial coefficients from u(w,w)_bi
        uxy = GetWithoutBinomials(uxy_bi);
