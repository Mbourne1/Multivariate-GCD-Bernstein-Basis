...
% % Inputs
%
% m1 : (Int) Degree of f(x) with respect to x
%
% m2 : (Int) Degree of f(x) with respect to y
%
% n1 : (Int) Degree of g(x) with respect to x
%
% n2 : (Int) Degree of g(x) with respect to y
%
% k1 : (Int) Degree of d(x) with respect to x
%
% k2 : (Int) Degree of d(x) with respect to y
%
%
% % Examples 
%
