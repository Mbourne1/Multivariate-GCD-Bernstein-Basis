function [dxy_calc] = o_gcd_2Polys(ex_num, emin, emax, mean_method, bool_alpha_theta, low_rank_approx_method, apf_method, sylvester_build_method)
...
% % Examples
%
% >> o_gcd_2Polys('1',1e-12,1e-10,'Geometric Mean Matlab Method','y','Standard STLN','None','DTQ')
...
[fxy_calc,gxy_calc,dxy_calc,uxy_calc, vxy_calc, t1, t2] = ...
    o_gcd_mymethod_2Polys(fxy_matrix, gxy_matrix, m, n, [lower_limit,upper_limit]);
