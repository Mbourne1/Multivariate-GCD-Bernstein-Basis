function [t1, t2, GM_fx, GM_gx, alpha, th1, th2] = GetGCDDegree_Relative_2Polys(fxy, gxy)
% Get the degree structure (t_{1} and t_{2}) of the GCD d(x,y) of the two
% polynomials f(x,y) and g(x,y)
%
% % Inputs.
%
% [fxy, gxy] : Coefficient matrix of polynomial f(x,y) and g(x,y)
%
% % Outputs 
%
...
for i = 1:1:nPairs
    ...
    Sk1k2 = BuildDTQ_2Polys(fww_matrix, alpha.*gww_matrix, v_k1, v_k2);
