function [] = plotMaxMinDiagonalsR1(mat_MaxDiagonals_R1, mat_MinDiagonals_R1, my_limits_t1, my_limits_t2)
%
% % Inputs
%
...
lowerLimit_k1 = my_limits_t1(1);
upperLimit_k1 = my_limits_t1(2);
lowerLimit_k2 = my_limits_t2(1);
upperLimit_k2 = my_limits_t2(2);
