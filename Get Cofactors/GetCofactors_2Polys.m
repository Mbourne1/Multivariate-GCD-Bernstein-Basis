function [uxy,vxy] = GetCofactors_2Polys(fxy, gxy, m, n, t, t1, t2, alpha, th1, th2)
%
% % Inputs
%
...
switch SETTINGS.CALC_METHOD
    case 'Relative'
        ...
        [uww, vww] = GetCofactors_Relative_2Polys(fww, a_gww,t1,t2);
        
    case 'Total'
        
        [uww, vww] = GetCofactors_Total_2Polys(fwww, alpha.*gww_n,m,n,t);
