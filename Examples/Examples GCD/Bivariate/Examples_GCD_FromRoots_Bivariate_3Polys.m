function [fxy, gxy, hxy, dxy, uxy, vxy, wxy, m, n, t] = Examples_GCD_FromRoots_Bivariate_3Polys(ex_num)
...
%
% wxy : (Matrix) Coefficients of polynomial v(x,y), the quotient polynomial
