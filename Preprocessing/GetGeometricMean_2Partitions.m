function [GM_fx] = GetGeometricMean_2Partitions(fxy, n1, n2, o1, o2, k1, k2)
...
DT1Q1 = BuildSubresultant_Partition_Bivariate_2Polys(fxy, n1 - k1, n2 - k2);
DT2Q2 = BuildSubresultant_Partition_Bivariate_2Polys(fxy, o1 - k1, o2 - k2);

% Get geometric mean of the nonzero entries

v1 = reshape(abs(DT1Q1(DT1Q1~=0)),1,[]);
v2 = reshape(abs(DT2Q2(DT2Q2~=0)),1,[]);
